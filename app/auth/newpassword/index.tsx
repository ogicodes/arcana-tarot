...
export default function ForgotPassword() {
  ...
  return (
    <SafeAreaView className="flex items-start justify-start bg-[#1E1E1E] h-full">
      <View className="border-b-[1px] border-[#DDDCDB] w-full mb-28">
      ...
      <View className="flex items-start justify-start w-full mb-10 ml-10">
        <Text className="text-4xl font-bold text-[#FEFEFF] font-mono mb-2">
          Create New Password
        </Text>
        <Text className="text-lg font-thin text-[#DDDCDB] font-momo">
